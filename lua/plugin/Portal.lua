return {
  ...
  config = function()
    require('portal').setup({
      ...
      query = {
        {
          predicate = function (jump)
            return require('portal.query').valid(jump) and jump.buffer == vim.api.nvim_get_current_buf()
          end,
          name = "Current Buffer",
          name_short = "In Buffer"
        },
        "modified", "different", "harpoon"
      },
